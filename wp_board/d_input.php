...
if($type == "pop"){
	// 페이지 이동 //
	echo ("<meta http-equiv='Refresh' content='0; URL=pop_index.html?code=$code&mode=list'>");
}else{
	// 페이지 이동 //
	echo ("<meta http-equiv='Refresh' content='0; URL=index.html?code=$code&mode=list'>");
}
?>