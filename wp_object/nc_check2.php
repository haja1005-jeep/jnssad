...
echo "/home/player/public_html/wp_object/cb_namecheck V799 52234141 1111111111111 test";
echo exec('whoami')."<br>";
echo exec('du -cm ../wp_icon/')."<br>";
...
//	$iReturnCode = exec ("/home/player/public_html/wp_object/cb_namecheck V799 52234141 1111111111111 test");
/*	 } else {
		echo ("
...
echo "처리후 iReturnCode:".$iReturnCode."<br>";
exit;
